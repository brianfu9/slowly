(function ($) {
   ...
   ------------------------------ */
    $.get('/getDB', (carDB) => {
        var carsDB = JSON.parse(carDB);
        $.get('/car_info', (car_info) => {

            var car_id = car_info['id'];
